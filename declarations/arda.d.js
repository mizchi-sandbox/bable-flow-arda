...
declare module Arda {
  declare class Router {
    ...
    constructor(layout: typeof Component, el: HTMLElement): Router;
  ...
  declare class Component<ComponentProps, InternalState> {
    refs: any;
  ...
  // Arda.Component extends React.Component
  declare class DefaultLayout<ComponentProps> extends Component<{}, {
  ...
  declare class Context<Props, State, ComponentProps> {
  ...
  declare function subscriber<Props, State>
  (
    fn: (
